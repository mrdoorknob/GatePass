    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav me-auto mb-1 mb-sm-0">
          <li class="nav-item">
            <a href="employeeDashboard.php" class="nav-link active">
              <svg class="bi" width="16" height="16">
                <use xlink:href="#home" />
              </svg> Dashboard</a>
          </li>
          <li class="nav-item">
            <a href="employeeGatePass.php" class="nav-link">
              <svg class="bi" width="16" height="16">
                <use xlink:href="#file-earmark-plus" />
              </svg> New Gatepass</a>
          </li>
          <li class="nav-item">
            <a href="employeeGatePassList.php?gatepassStatus='*'" class="nav-link">
              <svg class="bi" width="16" height="16">
