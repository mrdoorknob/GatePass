...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarsExample03">
        <ul class="navbar-nav me-auto mb-1 mb-sm-0">
          <li class="nav-item">
            <a href="supervisorDashboard.php" class="nav-link text-end active">
  ...
  <div class="container-fluid">
    <div class="row p-2 col-auto text-white text-center" style="background-color:#494dc0;">
      <h1> Dashboard </h1>
    </div>
    <hr />

    <!--<canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas>-->
    <div class="table-responsive col-auto bg-light">
      ...
      <table class="table table-striped table-md table-hover text-center" id="transactionTbl">
        ...
        <tbody>
          ...
          $query = "SELECT * FROM user WHERE dept='$department' ORDER BY username ASC";
          ...
          if ($result) {
            foreach ($result as $row) {
              ...
              $query = "SELECT * FROM gatepass WHERE username='$username' GROUP BY gatepassCode ORDER BY gatepassCode DESC";
              $statement = $conn->prepare($query);
              $statement->execute();
              $statement->setFetchMode(PDO::FETCH_OBJ); //PDO::FETCH_ASSOC
              $result = $statement->fetchAll();
          ...
          ?>
                  <tr>
                    ...
                    <td>
                      <a href="supervisorGatePassEdit.php?gatepassCode=<?= $row->gatepassCode ?>" class="btn btn-outline-info">
